...
const auto example_quantity = ctu::Quantity<long double, ExampleUnitDim>(4.0);
...
{
    const auto expected = ctu::Quantity<long double, ctu::UdMap<>>(1.0);
